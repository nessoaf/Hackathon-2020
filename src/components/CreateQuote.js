...
export default function CreateQuote() {
  ...
  const phaseTwo = () => {
    setImage(`./img/phase2.png`)
  }
  const phaseThree = () => {
    setImage(`./img/phase3.png`)
  }
  const phaseFour = () => {
    setImage(`./img/phase4.png`)
  }
  const phaseFive = () => {
    setImage(`./img/phase5.png`)
  }
  ...
  return (
    <div className="create-container">
      <DropdownOption phase1={phaseOne} phase2={phaseTwo} phase3={phaseThree} phase4={phaseFour} phase5={phaseFive} />
      <ImageCreated handleGenerate={handleGenerate} image={image} quote={quote}/>
      <DownloadOption />
    </div>
  )
}